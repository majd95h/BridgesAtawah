...
**ERP Heritage Logistics Suite — eh_log_cold_chain**
...
3. Install the module:
   ...
   .. code-block:: bash
      ...
      odoo-bin -d <database> -i eh_log_cold_chain --stop-after-init
...
To install **with demo data** (sample partners, sale orders, freight jobs, etc.) add ``--with-demo`` to a fresh database:
   ...
   .. code-block:: bash
      ...
      odoo-bin -d <database> -i eh_log_cold_chain --with-demo --stop-after-init
