...
**ERP Heritage Logistics Suite — eh_log_dangerous_goods**
...
3. Install the module:
   ...
   .. code-block:: bash
      ...
      odoo-bin -d <database> -i eh_log_dangerous_goods --stop-after-init
...
To install **with demo data** (sample partners, sale orders, freight jobs, etc.) add ``--with-demo`` to a fresh database:
   ...
   .. code-block:: bash
      ...
      odoo-bin -d <database> -i eh_log_dangerous_goods --with-demo --stop-after-init
