...
**ERP Heritage Logistics Suite — eh_log_warehouse_3pl**
...
3. Install the module:
   ...
   .. code-block:: bash
      ...
      odoo-bin -d <database> -i eh_log_warehouse_3pl --stop-after-init
...
To install **with demo data** (sample partners, sale orders, freight jobs, etc.) add ``--with-demo`` to a fresh database:
   ...
   .. code-block:: bash
      ...
      odoo-bin -d <database> -i eh_log_warehouse_3pl --with-demo --stop-after-init
